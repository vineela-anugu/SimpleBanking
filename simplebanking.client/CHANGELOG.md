...
- Create Angular project with ng: `ng new simplebanking.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`simplebanking.client.esproj`).
